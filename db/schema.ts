...
export const restaurantUsers = sqliteTable("restaurant_users", {
...
export const categories = sqliteTable("categories", {
  ...
  uniqueIndex("categories_restaurant_name_unique").on(table.restaurantId, table.name),
]);
...
export const ingredients = sqliteTable("ingredients", {
  ...
  uniqueIndex("ingredients_restaurant_name_unique").on(table.restaurantId, table.name),
]);
...
export const diningTables = sqliteTable("dining_tables", {
  ...
  uniqueIndex("dining_tables_restaurant_name_unique").on(table.restaurantId, table.name),
]);
...
export const stockMovements = sqliteTable("stock_movements", {
  ...
  index("stock_movements_ingredient_idx").on(table.ingredientId, table.createdAt),
]);
...
export const staffProfiles = sqliteTable("staff_profiles", {
  ...
  uniqueIndex("staff_profiles_restaurant_user_unique").on(table.restaurantId, table.userId),
]);
